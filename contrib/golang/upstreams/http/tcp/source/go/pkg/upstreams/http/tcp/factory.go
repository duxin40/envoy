...
func getHttpFilterFactoryAndConfig(name string, configId uint64) (api.TcpUpstreamFactory, interface{}) {
...
func getHttpFilterConfigParser(name string) api.TcpUpstreamConfigParser {
	if v, ok := httpFilterFactoryAndParser.Load(name); ok {
